      ...
      <div className="card  rounded-none h-full my-2 bg-yellow-100 shadow-xl">
        ...
        <div className="card-body  pt-4 px-4  text-center">
          ...
          <div className="card-actions justify-center ">
            <button className="btn text-white px-7  btn-ghost border-b-orange-500 border-b-4 bg-black  bg-opacity-60 hover:bg-black  hover:border-b-red-700  border-0">Add to cart</button>
          </div>
        </div>
      </div>
    </div>
